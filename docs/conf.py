# -*- coding: utf-8 -*-
#
# Neutrino documentation build configuration file, created by
...
cr = str(start_year) + '-' + str(current_year) + ', Lei Ma'
...
#theme_canonical_url = 'http://computational.neutrino.xyz/'
...
# pngmath_latex_preamble = latexpreamble
latex_elements = {"preamble": latexpreamble}
...
htmlhelp_basename = 'compneuphydoc'
...
latex_documents = [
  ('index', 'compneuphysics.tex', u'Computational Methods Notes',
   u'Lei Ma', 'manual'),
]
